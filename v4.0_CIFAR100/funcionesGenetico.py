...
def preprocesadoImagenes():
    ...
    (train_images, train_labels), (test_images, test_labels) = cifar.load_data(label_mode="fine")
...
def redNeuronal_CNN(configuracion, imagenes):
    ...
    model.add(Dense(100, activation='softmax')) #Tengo que mantenerla porq necesito de salida 10 neuronas
    ...
    model.compile(loss='categorical_crossentropy',
                  ...
                  metrics=['accuracy'])
    print("Training")
    model.fit(train_images, train_labels, steps_per_epoch=100,epochs=350,callbacks=[callback], verbose=1)
    print("Test")
